...
export PATH="$PATH:/home/nick/.emacs.d/bin"
...
__conda_setup="$('/home/nick/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
alias mdot='/usr/bin/git --git-dir=/home/nick/.mdot/ --work-tree=/home/nick'
